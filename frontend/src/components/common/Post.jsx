  ...
  const {
    ...
    mutationFn: async () => {
      try {
        ...
        console.log("delete post client ", error);
        throw new Error(error);
      }
    },
    onSuccess: () => {
      toast.success("Post deleted successfully");
      //invalidating to refetch the posts
  ...
  const { mutate: likePost, isPending: isLiking } = useMutation({
    mutationFn: async () => {
      try {
        ...
        console.log("Error in liking post client: ", error);
        throw new Error(error);
      }
    },
    onSuccess: (updatedLikes) => {
      toast.success("Post liked");
      //invalidating would take time
  ...
  const { mutate: commentPost, isPending: isCommenting } = useMutation({
    mutationFn: async () => {
      try {
        ...
        if (!res.ok)
          throw new Error(
            data.error || "Something went wrong while commenting on post"
          );

        return data;
      } catch (error) {
        console.log("Error in deleting post client: ", error);
        throw new Error(error);
      }
    },
    onSuccess: () => {
      ...
      <div className="flex gap-2 items-start p-4 border-b border-gray-700">
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="flex justify-between mt-3">
            <div className="flex gap-20 items-center w-full justify-center">
              <div
              ...
              >
                ...
                {isLiked && !isLiking && (
                  <FaHeart className="w-5 h-5 cursor-pointer text-pink-500 text-md " />
                )}

                <span
                  className={`text-lg  group-hover:text-pink-500 ${
              ...
              >
                <FaRegComment className="w-5 h-5  text-slate-500 group-hover:text-[#b491c8]" />
                <span className="text-lg text-slate-500  group-hover:text-[#b491c8]">
